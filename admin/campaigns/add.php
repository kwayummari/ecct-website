...
if ($_POST) {
    ...
    if (!empty($title) && !empty($description) && $goal_amount > 0) {
        ...
        if ($db->insert('campaigns', $data)) {
            header('Location: list.php?success=Campaign added successfully');
            exit;
        } else {
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="3"
                                        placeholder="Brief description of the campaign" required><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
                                </div>

                                <div class="mb-3">
                                    <label for="content" class="form-label">Full Content</label>
                                    <textarea class="form-control" id="content" name="content" rows="8"><?php echo htmlspecialchars($_POST['content'] ?? ''); ?></textarea>
                                </div>
